...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText mMessage = (EditText)findViewById(R.id.inputMsg);
        final Button mPostSend = (Button) findViewById(R.id.btnSend); //"final" pour être accédé depuis l'intérieur d'une classe

        //activation du bouton si saisie dans les champs de pseudo ou de contact
        ...
        try {
            ...
            String urlParameters = "pseudo="+mPseudo.getText()+"contact="+mContact.getText()+"message="+mMessage.getText();
